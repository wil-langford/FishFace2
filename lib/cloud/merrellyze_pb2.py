...
_IMAGE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='request_id', full_name='merrellyze.Image.request_id', index=3,
...
_ELLIPSESEARCHREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='request_id', full_name='merrellyze.EllipseSearchRequest.request_id', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='cjrs', full_name='merrellyze.EllipseSearchRequest.cjrs', index=1,
...
_ELLIPSETAG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='request_id', full_name='merrellyze.EllipseTag.request_id', index=6,
...
_RESULTRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='tags', full_name='merrellyze.ResultResponse.tags', index=0,
      number=1, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_RESULTRESPONSE.fields_by_name['tags'].message_type = _ELLIPSETAG
